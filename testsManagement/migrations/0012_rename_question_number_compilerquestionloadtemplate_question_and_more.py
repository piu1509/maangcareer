...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('testsManagement', '0011_questiontimer_compilerquestion_course_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='button_clicked',
            field=models.CharField(blank=True, choices=[('Run', 'Run'), ('Submit', 'Submit')], max_length=11, null=True),
        ),
        migrations.AddField(
            model_name='compilerquestionatempt',
            name='load_template',
        ...
        migrations.AddField(
            model_name='questiontimer',
            name='week_pass_percent',
            field=models.PositiveBigIntegerField(blank=True, null=True),
        ),
        migrations.AlterField(
            model_name='questiontimer',
            name='exam_field',
            field=models.CharField(blank=True, choices=[('Quiz', 'Quiz'), ('Mock', 'Mock')], max_length=20, null=True),
        ),
    ]
